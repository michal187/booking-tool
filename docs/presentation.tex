...
\begin{frame}{Architecture}
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      \centering
      \fbox{\parbox[c][0.52\textheight][c]{0.9\textwidth}{\centering
      Architecture diagram\\or app screenshot}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Key User Flow}
  \begin{columns}[T]
    ...
    \begin{column}{0.46\textwidth}
      ...
      Reservation flow screenshot\\or sequence diagram}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{What The MVP Already Handles}
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      \centering
      \fbox{\parbox[c][0.5\textheight][c]{0.9\textwidth}{\centering
      Dashboard screenshot\\or admin panel screenshot}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Testing And Demo Readiness}
  \begin{columns}[T]
    ...
    \begin{column}{0.4\textwidth}
      \centering
      \fbox{\parbox[c][0.42\textheight][c]{0.9\textwidth}{\centering
      Test results screenshot\\or UML snapshot}}
    \end{column}
  \end{columns}
\end{frame}
